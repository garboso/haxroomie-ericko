...
const RED_ID = 1,
  ...
  ERICKO_TEAMS = [
    ...
    { name: 'Pibinho y los Yakus', acronym: 'PIB', icon: '💰', custom: true, color: 0xFFF712 },
    { name: 'eaemaranga', acronym: 'EAE', icon: '💪', custom: true, color: 0xFAAB7D },
    { name: 'Vasco', acronym: 'VAS', icon: '✠', custom: true, color: 0xFFFFFF },
    { name: 'Dinizistas Drogados', acronym: 'DIN', icon: '🚬', custom: true, color: 0xFF80F7 },
    { name: 'Sunga Branca', acronym: 'SUN', icon: '🩲', custom: true, color: 0xFFFFFF },
    { name: 'X9 Paulistana', acronym: 'XPA', icon: '🎉', custom: true, color: 0x0DC52B }],
  DEFAULT_TEAMS = {
